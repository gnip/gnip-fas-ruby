...
#=======================================================================================================================
#A simple, common RESTful HTTP class put together for Gnip endpoints.
#Provides helper functions for spinning up Gnip URLs.
#    Can set class 'account_name' and 'label' attributes, or pass them in to methods.
#         oHTTP = PtRESTful.new
#         oHTTP.account_name = 'account_name'
#         oHTTP.label = 'prod'
#         url = oHTTP.getFaSearchURL --> https://data-api.twitter.com/search/fullarchive/accounts/account_name/prod.json
#     or  url = oHTTP.getFaSearchURL('account_name', 'prod') --> https://data-api.twitter.com/search/fullarchive/accounts/account_name/prod.json
...
class PtRESTful
    ...
    def getSearchURL(account_name=nil,label=nil)
        ...
        if label.nil? then #user not passing in anything...
            if @label.nil?
                puts "No stream label (like 'prod' or 'dev') set.  Can not set url."
                return @url  #albeit incomplete.
            end
            @url = @url + "#{@label}.json"
        else
    ...
    def getFaSearchCountURL(account_name=nil,label=nil)
